...
pub const DEVICE_NAME_SHUTTER: &str = "LED illumination";

static DEVICE_LIST: &[DeviceInfo] = &[
    DeviceInfo {
        name: DEVICE_NAME_HUB,
        description: "Sangaboard Hub",
        device_type: DeviceType::Hub,
    },
    DeviceInfo {
        name: DEVICE_NAME_XYSTAGE,
        description: "OpenFlexure XY stage",
        device_type: DeviceType::XYStage,
    },
    DeviceInfo {
        name: DEVICE_NAME_ZSTAGE,
        description: "OpenFlexure Z stage",
