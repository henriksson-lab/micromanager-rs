...
///   `mess,<ch>\r`          → read value; response: `mess,<ch>,<val>`
...
impl PsjDDriveStage {
    ...
    pub fn new(channel: u8) -> Self {
        ...
        props
            ...
            .unwrap();
        props
            .define_property("MaxPosition_um", PropertyValue::Float(50.0), false)
            .unwrap();
        Self {
            props,
            transport: None,
...
impl Device for PsjDDriveStage {
    ...
    fn initialize(&mut self) -> MmResult<()> {
        ...
        // Read current value
        let rd_resp = self.cmd(&format!("mess,{}", ch))?;
...
mod tests {
    ...
    fn channel_3_init() {
        let t = MockTransport::new()
            ...
            .expect("mess,3", "mess,3,35.5"); // 35.5µm in closed loop
