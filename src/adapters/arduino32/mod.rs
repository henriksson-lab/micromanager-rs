...
static DEVICE_LIST: &[DeviceInfo] = &[
    DeviceInfo {
        ...
        description: "Arduino32 Hub (required)",
        device_type: DeviceType::Hub,
    },
    DeviceInfo {
        name: DEVICE_NAME_SHUTTER,
        description: "Arduino32 shutter (digital LSB)",
        device_type: DeviceType::Shutter,
    },
    DeviceInfo {
        name: DEVICE_NAME_SWITCH,
        description: "Arduino32 8-bit digital output",
    ...
    DeviceInfo {
        name: DEVICE_NAME_DA1,
        description: "Arduino32 DAC/PWM channel 1",
        device_type: DeviceType::SignalIO,
    },
    DeviceInfo {
        name: DEVICE_NAME_DA2,
        description: "Arduino32 DAC/PWM channel 2",
        device_type: DeviceType::SignalIO,
    },
    DeviceInfo {
        name: DEVICE_NAME_DA3,
        description: "Arduino32 DAC/PWM channel 3",
        device_type: DeviceType::SignalIO,
    },
    DeviceInfo {
        name: DEVICE_NAME_DA4,
        description: "Arduino32 DAC/PWM channel 4",
        device_type: DeviceType::SignalIO,
    },
    DeviceInfo {
        name: DEVICE_NAME_DA5,
        description: "Arduino32 DAC/PWM channel 5",
        device_type: DeviceType::SignalIO,
    },
    DeviceInfo {
        name: DEVICE_NAME_DA6,
        description: "Arduino32 DAC/PWM channel 6",
        device_type: DeviceType::SignalIO,
    },
    DeviceInfo {
        name: DEVICE_NAME_DA7,
        description: "Arduino32 DAC/PWM channel 7",
        device_type: DeviceType::SignalIO,
    },
    DeviceInfo {
        name: DEVICE_NAME_DA8,
        description: "Arduino32 DAC/PWM channel 8",
        device_type: DeviceType::SignalIO,
    },
];
