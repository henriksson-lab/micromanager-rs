...
static DEVICE_LIST: &[DeviceInfo] = &[
    DeviceInfo {
        ...
        description: "Arduino Hub (required)",
        device_type: DeviceType::Hub,
    },
    DeviceInfo {
        name: DEVICE_NAME_SHUTTER,
        description: "Arduino shutter (digital out LSB)",
        device_type: DeviceType::Shutter,
    },
    DeviceInfo {
        name: DEVICE_NAME_SWITCH,
        description: "Arduino 8-bit digital output",
        device_type: DeviceType::State,
    },
    DeviceInfo {
        name: DEVICE_NAME_DA1,
        description: "Arduino DAC channel 1",
        device_type: DeviceType::SignalIO,
    },
    DeviceInfo {
        name: DEVICE_NAME_DA2,
        description: "Arduino DAC channel 2",
        device_type: DeviceType::SignalIO,
    },
];
